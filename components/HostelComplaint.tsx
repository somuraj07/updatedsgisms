...
export default function HostelForm() {
  ...
  if (!user) {
    return <p className="text-center text-purple-700 font-semibold mt-10">Please log in to submit a hostel complaint.</p>;
  }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-400 via-purple-300 to-white p-4">
      ...
      >
        <h2 className="text-2xl font-bold text-center text-purple-700 mb-4">Hostel Complaint</h2>
